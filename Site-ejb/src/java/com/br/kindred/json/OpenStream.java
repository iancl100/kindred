...
//            HttpURLConnection con = (HttpURLConnection) url.openConnection(proxy);
            ...
            if(code==400)System.out.println("Bad request");
            else if(code==401)System.out.println("Unauthorized");
            else if(code==403){
                System.out.println("No summoner data found for any specified inputs"); 
                return "403";
            }
            else if(code==429)System.out.println("Rate limit exceeded");
            else if(code==500)System.out.println("Internal server error");
            else if(code==503)System.out.println("Service unavailable");
            else if(code==200){
